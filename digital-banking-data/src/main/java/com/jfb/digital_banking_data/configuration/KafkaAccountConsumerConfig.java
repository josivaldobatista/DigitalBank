...
public class KafkaAccountConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaAccountListenerContainerFactory() {
    ...
    @Bean
    public ConsumerFactory<String, String> accountStringConsumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> accountStringKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(accountStringConsumerFactory());
        return factory;
    }
}
