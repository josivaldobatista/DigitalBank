...
public class KafkaCustomerConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Object> customerConsumerFactory() {
    ...
    @Bean
    public ConsumerFactory<String, String> customerStringConsumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> stringKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(customerStringConsumerFactory());
        return factory;
    }
}
